      ...
      <nav className="nav">
        <ul className="nav-list">
          ...
          >
            ...
            {openMenu === "projects" && (
              <ul className="dropdown">
                ...
                <li><a href="#projects">Amazon Clone</a></li>
                <li><a href="#projects">Student Attendance Tracker</a></li>
                <li><a href="#projects">Portfolio Website</a></li>
              </ul>
            )}
          </li>
          ...
          >
            ...
            {openMenu === "education" && (
              <ul className="dropdown">
                <li><a href="#education">PhD (Planned)</a></li>
                <li><a href="#education">MSc</a></li>
                <li><a href="#education">BSc</a></li>
          ...
          >
            ...
            {openMenu === "experience" && (
              <ul className="dropdown">
                ...
                <li><a href="#experience">Frontend Developer</a></li>
                <li><a href="#experience">Backend Developer</a></li>
        ...
        <ul>
          ...
          <li>
            ...
            {mobileDropdown === "education" && (
              <ul>
                <li><a href="#education" onClick={() => setMobileOpen(false)}>PhD (Planned)</a></li>
