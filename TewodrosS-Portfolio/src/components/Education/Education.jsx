...
function Education() {
  const education = [
    {
  title: "Ph.D. Graduate Studies in Agriculture",
  school: "Czech University of Life Sciences, Prague, Czech Republic",
  year: "2021 - 2023",
  desc: "Research focus on open channel flow, irrigation structures, and hydrological modeling for sustainable water management.",
},

    {
  title: "Master Studies in Informatics",
  school: "Czech University of Life Sciences, Prague, Czech Republic",
  year: "2023",
  desc: "Studied core concepts of Informatics, with focus on information systems and applied technologies.",
},
    {
  ...
  {
  title: "Master Studies in Water Resources Engineering Management",
  school: "Hawassa University, Ethiopia",
  year: "2018",
  desc: "Studied integrated water resources management and environmental engineering practices, GIS and remote sensing.",
},
{
